 ...
 */
public class PlaySession_Imp implements PlaySession {
     ...
     */
    public PlaySession_Imp(Date date, Player host, BoardGame game, int playTime, Collection<Player> players, Player winner) {
        this.date = date;
        this.host = host;
        this.game = game;
